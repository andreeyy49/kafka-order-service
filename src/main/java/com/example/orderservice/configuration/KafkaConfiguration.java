...
public class KafkaConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, OrderResponse> kafkaMessageConsumerFactory(ObjectMapper objectMapper) {
        Map<String, Object> config = new HashMap<>();
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OrderResponse> kafkaMessageConcurrentKafkaListenerContainerFactory(
            ConsumerFactory<String, OrderResponse> kafkaMessageConsumerFactory) {
